...
def insert_new_items(client_id, df, status_id, batch_size=5000):
    ...
    # Colunas opcionais
    columns_reforma_tributaria = [
        'cst_ibs_cbs', 'c_class_trib', 'aliquota_ibs',
        'aliquota_cbs', 'p_red_aliq_ibs', 'p_red_aliq_cbs'
    ]    
        ...
        try:
            with transaction.atomic():
                ...
                for _, row in batch.iterrows():
                    ...
                    # Adiciona colunas opcionais apenas se existirem no DataFrame
...
def validateSelect(client_id, items_df, df, initial_log=None):
    ...
    # Verificando se as colunas da Reforma Tributaria em 2026 estao presentes
    ...
    print('2-Verificando se as colunas existem')
